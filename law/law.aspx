<%@ Page Language="C#" AutoEventWireup="true" CodeFile="law.aspx.cs" Inherits="_Law" ViewStateMode="Disabled"%>
...
<p class="back"><a title="返回" href="../metro.aspx"></a> </p>
...
<script type="text/javascript">
  ...
  <div class="clear"></div>
  <section id="leftside">
    <h1 class="solve" style="background:url(../images/law_title2.jpg) no-repeat;">
       
      <span class="white font_48 yahei" id="solvetitle2">政策法规<br /><br /><br /></span>
      </h1>
  </section>
  <section id="rightside">
    <ul class="solvemenu yahei white font_15 b">
 <!--安全的智能园menu:开始-->
  <li class="m1"><a href="javascript:void(0)" style="width:148px; height: 30px; display: block; background-image: url(../images/law/law_m1.jpg); background-position: 0% 100%; background-repeat: no-repeat no-repeat;" class="current">法律</a></li>
  <li class="m2"><a href="javascript:void(0)" style="width:148px; height:30px; display:block; background:url(../images/law/law_m2.jpg) no-repeat;">法规及规章</a></li>
  <li class="m3"><a href="javascript:void(0)" style="width:148px; height:30px; display:block; background:url(../images/law/law_m3.jpg) no-repeat;">司法解释</a></li>
  <li class="m4"><a href="javascript:void(0)" style="width:148px; height:30px; display:block; background:url(../images/law/law_m4.jpg) no-repeat;">政策文件</a></li>
<!--安全的智能园menu:结束--> 
      <div class="clear"></div>
    </ul>
